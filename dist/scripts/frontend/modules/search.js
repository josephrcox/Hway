...
var openButton = document.getElementById('search-button');
export var bar = document.getElementById('searchbar');
var submit = document.getElementById("search_submit");
export var phrase = document.getElementById("search_phrase");
export var topic = document.getElementById("search_topic");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    startLoaders();
                    return [4 /*yield*/, apiGetPostsBySearchQuery(phrase.value + "", topic.value + "")];
                case 1:
                    _a.sent();
                    stopLoaders();
                    return [2 /*return*/];
