...
var register_logs = document.getElementById("logs");
...
function registerUser() {
    return __awaiter(this, void 0, void 0, function () {
        var bodyJSON, fetchResponse, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(password.value.length < 8 || password.value.length > 50 || username.value.length < 3 || username.value.length > 30 || !username.validity.valid || !password.validity.valid)) return [3 /*break*/, 1];
                    register_logs.innerHTML = "Please make sure your username: <br/>- Has only letters, numbers, _'s, and -'s<br/>- Is 3-30 characters";
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch('/api/post/register', {
                            headers: {
